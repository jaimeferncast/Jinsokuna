...
const { checkRights } = require("../middlewares")

const User = require("../models/user.model")

// Get all users
router.get("/", checkRights, async (_req, res) => {
  try {
...
// Update user
router.put("/:_id", checkRights, async (req, res) => {
...
// Delete user
router.delete("/:_id", checkRights, (req, res) => {
